# Merge freqs back with its original file, aligning them to the reference.
...
file[, pid:=paste(CHR,BP, sep=":")][,c("REF","ALT"):=list(toupper(REF),toupper(ALT))]
freqs[, pid:=paste(CHR,BP, sep=":")]
