# Creating LDpred2 reference panel using 1000Genomes Phase III. 
# This script will create a 1000Genomes Phase III reference panel for LDpred2 from scratch, and filter it by HapMap3 variants, as recommended
# by LDpred2 tutorial
# 2020/12/15
