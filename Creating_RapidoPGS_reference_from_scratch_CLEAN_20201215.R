# Creating RápidoPGS-multi reference panel using 1000Genomes Phase III. 
# This code will use 1000 Genomes Phase III reference panel for RápidoPGS-multi.
...
# This step is required to make all RápidoPGS runs comparable, since RápidoPGS-single doesn't need a panel and uses all available variants.
# By filtering datasets by this list of variants, we'll use the same variants a priori in both approaches.
