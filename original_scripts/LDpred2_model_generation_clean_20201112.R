...
# In reality, we splitted this code per dataset prior to submission to the HPC, due to runtime constraints.
...
# In practice, given the long time to run we will do one dataset per run, so I ditch the for loop and use the index of the dataset (provided by the argument)
x <- args
# for (x in 1:10){
