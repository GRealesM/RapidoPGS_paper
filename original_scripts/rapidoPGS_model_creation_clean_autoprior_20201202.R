...
# 2020/12/02
# NOTE: This script will compute rapidopgs_multi for binary traits using automatic computation (in the fashion of v2 of the paper). sd.prior=0.2 runs will be commented.
# NOTE: Differences with previous (20201112) version is that now quantitative traits will be included, so we show automatic prior computation results for those, too. Since this mode was run after the rest of the models, everything else is commented.
