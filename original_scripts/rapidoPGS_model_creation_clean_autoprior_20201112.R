...
# NOTE: This script will compute rapidopgs_multi for binary traits using automatic computation (in the fashion of v2 of the paper). sd.prior=0.2 runs will be commented. Quantitative traits and all rapidopgs_single will be commented as well, since they will be computed by rapidoPGS_model_creation_clean_20201112.R.
...
sapply(datasets[5:8], function(x){
	filebasename <- strsplit(x, split="-")[[1]][1]
	ds <- fread(paste0(dspath,x))
